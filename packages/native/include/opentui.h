...
#define OT_SCENE_ALIGN_LEFT UINT32_C(0)
#define OT_SCENE_ALIGN_CENTER UINT32_C(1)
#define OT_SCENE_ALIGN_RIGHT UINT32_C(2)
 ...
 * left alignment, and no truncation. No custom providers or raw handles. */
typedef struct ot_scene_text_options {
    ...
    uint32_t text_align; /* OT_SCENE_ALIGN_*: left=0, center=1, right=2. */
...
#define OT_EMBEDDED_TERMINAL_SET_TRANSPARENT_BACKGROUND UINT32_C(3)
...
/* Mouse pointer shapes, named after CSS cursor values. */
#define OT_MOUSE_POINTER_AUTO UINT32_C(0)
#define OT_MOUSE_POINTER_DEFAULT UINT32_C(1)
#define OT_MOUSE_POINTER_NONE UINT32_C(2)
#define OT_MOUSE_POINTER_CONTEXT_MENU UINT32_C(3)
#define OT_MOUSE_POINTER_HELP UINT32_C(4)
#define OT_MOUSE_POINTER_POINTER UINT32_C(5)
#define OT_MOUSE_POINTER_PROGRESS UINT32_C(6)
#define OT_MOUSE_POINTER_WAIT UINT32_C(7)
#define OT_MOUSE_POINTER_CELL UINT32_C(8)
#define OT_MOUSE_POINTER_CROSSHAIR UINT32_C(9)
#define OT_MOUSE_POINTER_TEXT UINT32_C(10)
#define OT_MOUSE_POINTER_VERTICAL_TEXT UINT32_C(11)
#define OT_MOUSE_POINTER_ALIAS UINT32_C(12)
#define OT_MOUSE_POINTER_COPY UINT32_C(13)
#define OT_MOUSE_POINTER_MOVE UINT32_C(14)
#define OT_MOUSE_POINTER_NO_DROP UINT32_C(15)
#define OT_MOUSE_POINTER_NOT_ALLOWED UINT32_C(16)
#define OT_MOUSE_POINTER_GRAB UINT32_C(17)
#define OT_MOUSE_POINTER_GRABBING UINT32_C(18)
#define OT_MOUSE_POINTER_ALL_SCROLL UINT32_C(19)
#define OT_MOUSE_POINTER_COL_RESIZE UINT32_C(20)
#define OT_MOUSE_POINTER_ROW_RESIZE UINT32_C(21)
#define OT_MOUSE_POINTER_N_RESIZE UINT32_C(22)
#define OT_MOUSE_POINTER_E_RESIZE UINT32_C(23)
#define OT_MOUSE_POINTER_S_RESIZE UINT32_C(24)
#define OT_MOUSE_POINTER_W_RESIZE UINT32_C(25)
#define OT_MOUSE_POINTER_NE_RESIZE UINT32_C(26)
#define OT_MOUSE_POINTER_NW_RESIZE UINT32_C(27)
#define OT_MOUSE_POINTER_SE_RESIZE UINT32_C(28)
#define OT_MOUSE_POINTER_SW_RESIZE UINT32_C(29)
#define OT_MOUSE_POINTER_EW_RESIZE UINT32_C(30)
#define OT_MOUSE_POINTER_NS_RESIZE UINT32_C(31)
#define OT_MOUSE_POINTER_NESW_RESIZE UINT32_C(32)
#define OT_MOUSE_POINTER_NWSE_RESIZE UINT32_C(33)
#define OT_MOUSE_POINTER_ZOOM_IN UINT32_C(34)
#define OT_MOUSE_POINTER_ZOOM_OUT UINT32_C(35)
#define OT_MOUSE_POINTER_MAX OT_MOUSE_POINTER_ZOOM_OUT
/* Editor options only: leave the current mouse pointer unchanged. */
#define OT_MOUSE_POINTER_UNCHANGED UINT32_C(0xFFFFFFFF)
 ...
 * mouse_pointer is an OT_MOUSE_POINTER_* shape or OT_MOUSE_POINTER_UNCHANGED. */
...
#define OT_TEXT_VIEW_TEXT_ALIGN UINT32_C(5)
 ...
 * is an OT_MOUSE_POINTER_* shape. Color uses the packed RGBA lanes. Unselected
 * fields must be zero. */
...
/* Read the link id stored in one current-framebuffer cell. Does not retain
 * storage and does not require an idle frame. Encode syncs those cells before
 * presentation is pending, so the read stays valid while output drains.
 * Negative or out-of-range coordinates write 0 and succeed. out_link_id is
 * required; rejection leaves it unchanged. */
ot_status ot_session_get_link_id(
    ot_context *context,
    const ot_handle *session,
    int32_t x,
    int32_t y,
    uint32_t *out_link_id);
