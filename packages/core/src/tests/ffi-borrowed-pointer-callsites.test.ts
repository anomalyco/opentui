...
describe("borrowed pointer call sites", () => {
  ...
  test("image calls pass transient buffer owners directly", () => {
    ...
    try {
      ...
      expect(calls.get("ot_image_decode")![3]).toBeInstanceOf(Uint32Array)
      expect(calls.get("ot_image_create_pixels")![8]).toBeInstanceOf(Uint32Array)
      expect(calls.get("ot_image_get_info")![2]).toBeInstanceOf(Uint32Array)
      expect(calls.get("ot_image_retain")![2]).toBeInstanceOf(Uint32Array)
      expect(calls.get("ot_image_clone")![3]).toBeInstanceOf(Uint32Array)
      expect(calls.get("ot_image_resize")![5]).toBeInstanceOf(Uint32Array)
      expect(calls.get("ot_image_extract")![6]).toBeInstanceOf(Uint32Array)
      expect(calls.get("ot_image_extend")![7]).toBeInstanceOf(Uint32Array)
      expect(calls.get("ot_image_transform")![3]).toBeInstanceOf(Uint32Array)
      expect(calls.get("ot_image_composite")![7]).toBeInstanceOf(Uint32Array)
    } finally {
